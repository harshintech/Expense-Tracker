...
import CARD_2 from "../../assets/images/card3.jpg";
  ...
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <div className="w-48 h-56 rounded-[40px] border-[20px] border-black absolute top-[30%] -right-10" />
        <div className="w-48 h-48 rounded-[40px] bg-black absolute -bottom-7 -left-5" />

        <div className="grid grid-cols-1 z-20">
          <StateInfoCard
            icon={<FaUser />}
            label="Welcome To My Expense Tracker App"
            value="Harsh In Tech ( Harsh Gohil )"
            color="bg-primary"
          />
          <StateInfoCard
...
const StateInfoCard = ({ icon, label, value, color }) => {
  return (
    <div className="flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-400/10 border border-gray-200/50 z-10 mb-6">
      <div
